...
test('Reservations launcher and static bundle stay inside the unified Platform artifact',()=>{
  ...
  assert.match(index,/modules\/reservations\/reservations-module\.js\?rev=mountable-bundle-v9/);
  assert.match(index,/modules\/reservations\/reservations-module\.css\?rev=mountable-bundle-v9/);
  assert.match(worker,/\.\/modules\/reservations\/reservations-module\.js\?rev=mountable-bundle-v9/);
  assert.match(worker,/\.\/modules\/reservations\/reservations-module\.css\?rev=mountable-bundle-v9/);
