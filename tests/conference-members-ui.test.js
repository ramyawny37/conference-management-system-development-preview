...
async function run(){
  ...
  assert.ok(
    /const\s+CACHE_REVISION\s*=\s*IS_DEVELOPMENT\s*\?\s*['"]development-3-4-0-cold-refresh-startup-ordering-v1['"]\s*:\s*['"]production-integrated-3-3-0-main-6d0c1e1-develop-80653ca-v1['"]\s*;/
