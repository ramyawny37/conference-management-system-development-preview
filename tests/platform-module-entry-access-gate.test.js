...
test('route restores use PlatformIntegration and deterministic assets remain aligned',()=>{
  ...
  assert.match(index,/js\/platform-integration\.js\?rev=platform-dashboard-v2-v3/);
  assert.match(worker,/\.\/js\/platform-integration\.js\?rev=platform-dashboard-v2-v3/);
  assert.match(index,/script\.js\?rev=platform-dashboard-v2-v3/);
  assert.match(worker,/\.\/script\.js\?rev=platform-dashboard-v2-v3/);
  assert.match(index,/reservations-module\.js\?rev=platform-dashboard-v2-v3/);
