...
const cacheMarker='production-baseline-af6b910-v1';
const memberDiagnosticsAssetMarker='production-baseline-af6b910-v1';
const shellMarker='production-baseline-af6b910-v1';
const houseMarker='template-floor-conference-sync-v1';
const scriptMarker='organization-members-refresh-v1';
const privacyMarker='shared-template-copy-guard-v1';
