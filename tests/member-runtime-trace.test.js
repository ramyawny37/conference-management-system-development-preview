...
const marker='member-runtime-trace-v1';
...
[
  'js/sync/sync-settings-ui.js?rev='+marker,
...
assert.ok(settingsSource.includes(marker));
assert.ok(source.includes(marker));
assert.ok(fs.readFileSync(path.join(
  root,'js/sync/discovered-conference-open-service.js'),'utf8').includes(marker));
