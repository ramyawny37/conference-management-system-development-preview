...
assert.match(app,/function restoreLastApplicationTab\(options\)[\s\S]*?var settingsTabId=getApplicationTabIdByName\('settings'\);[\s\S]*?if\(restored&&restoredTab===settingsTabId\)\{\s*resetAdministrativeViewScroll\(\)/);
