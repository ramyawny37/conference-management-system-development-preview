...
async function run(){
  ...
  assert.match(workerSource,
    /const CACHE_REVISION = IS_DEVELOPMENT\s*\? 'development-3-4-0-opening-balance-ux-correction-v1'\s*:\s*'production-integrated-3-3-0-main-6d0c1e1-develop-80653ca-v1';/);
