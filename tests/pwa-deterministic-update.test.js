...
const cacheRevision='development-3-4-0-platform-shell-phase2a-v1';
...
const platformShellScriptRevision='platform-shell-phase2a-v1';
...
const userManagementStyleRevision='platform-shell-phase2a-v1';
