...
const cacheRevision='development-3-4-0-warehouse-rtl-sidebar-position-v1';
const startupTransportRevision='startup-transport-cleanup-v1';
const moduleRoutingRevision='warehouse-original-shell-round1-v1';
...
const userManagementStyleRevision='warehouse-rtl-sidebar-position-v1';
