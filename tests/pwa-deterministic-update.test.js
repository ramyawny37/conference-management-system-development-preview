...
const cacheRevision='development-target-mpez-v1';
...
const phaseADeviceAdministrationAsset='js/supabase/device-authorization-administration-service.js?rev=webauthn-privileged-admin-disabled-v1';
assert(index.includes(phaseADeviceAdministrationAsset),'index missing '+phaseADeviceAdministrationAsset);
assert(worker.includes("'./"+phaseADeviceAdministrationAsset+"'"),'app shell missing '+phaseADeviceAdministrationAsset);
