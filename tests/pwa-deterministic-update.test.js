...
const cacheRevision='development-3-4-0-base-path-module-routing-v1';
...
const platformShellScriptRevision='base-path-module-routing-v1';
...
assert.match(worker,/base-path-module-routing-v1/);
