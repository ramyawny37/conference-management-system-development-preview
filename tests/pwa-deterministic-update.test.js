...
const cacheRevision='development-3-4-0-integration-reconciliation-v3';
...
const platformShellScriptRevision='conference-route-restoration-v2';
...
assert.match(worker,/integration-reconciliation-v3/);
