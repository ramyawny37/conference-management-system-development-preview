...
(async function(){
  ...
  assert.ok(worker.includes("CACHE_REVISION = 'account-scoped-device-identity-v1'"));
  ...
  assert.ok(index.includes('current-device-authorization-ui.js?rev=account-scoped-device-identity-v1'));
  assert.ok(worker.includes('current-device-authorization-ui.js?rev=account-scoped-device-identity-v1'));
