...
(async function(){
  ...
  assert.ok(worker.includes("CACHE_REVISION = 'launch-membership-integrity-v1'"));
  ...
  assert.ok(index.includes('current-device-authorization-ui.js?rev=launch-membership-integrity-v1'));
  assert.ok(worker.includes('current-device-authorization-ui.js?rev=launch-membership-integrity-v1'));
