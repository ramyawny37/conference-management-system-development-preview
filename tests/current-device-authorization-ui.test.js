...
(async function(){
  ...
  assert.ok(worker.includes("CACHE_REVISION = 'organization-membership-operation-key-v1'"));
  ...
  assert.ok(index.includes('current-device-authorization-ui.js?rev=organization-membership-operation-key-v1'));
  assert.ok(worker.includes('current-device-authorization-ui.js?rev=organization-membership-operation-key-v1'));
