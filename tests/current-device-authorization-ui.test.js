...
(async function(){
  ...
  assert.ok(worker.includes("CACHE_REVISION = 'startup-device-admin-lifecycle-v1'"));
  ...
  assert.ok(index.includes('current-device-authorization-ui.js?rev=device-onboarding-v1'));
  assert.ok(worker.includes('current-device-authorization-ui.js?rev=device-onboarding-v1'));
