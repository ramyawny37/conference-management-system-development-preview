...
assert.match(html,/platform-shell-v2\.css\?rev=platform-shell-v2-v1/);
assert.match(worker,/platform-shell-v2\.css\?rev=platform-shell-v2-v1/);
...
assert.match(css,/min-height:var\(--platform-touch-target\)/);
assert.match(css,/padding-bottom:var\(--platform-safe-area-bottom\)/);
