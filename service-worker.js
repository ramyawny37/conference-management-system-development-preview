...
const CACHE_REVISION = 'accommodation-display-state-v1';
...
const CORE_ASSETS = [
  ...
  './js/sync/discovered-conference-open-service.js?rev=accommodation-display-state-v1',
  './js/sync/member-runtime-diagnostics.js?rev=accommodation-display-state-v1',
  ...
  './cards.js',
  './script.js?rev=accommodation-selector-state-v1',
  './version.js',
  './pwa.js',
