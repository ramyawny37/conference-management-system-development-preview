...
const CACHE_REVISION = 'account-scoped-device-identity-v1';
...
const CORE_ASSETS = [
  ...
  './js/storage/conference-publishing-engine.js?rev=account-scoped-device-identity-v1',
  './js/storage/conference-publish-recovery.js?rev=account-scoped-device-identity-v1',
  ...
  './js/supabase/auth.js?rev=account-scoped-device-identity-v1',
  './js/supabase/system-access-service.js',
  './js/sync/organization-administration-utils.js',
  './js/sync/access-diagnostics-ui.js?rev=account-scoped-device-identity-v1',
  './js/sync/organization-membership-operation-repository.js',
  './js/supabase/organization-administration-service.js?rev=account-scoped-device-identity-v1',
  ...
  './js/supabase/device-identity.js?rev=account-scoped-device-identity-v1',
  './js/sync/device-authorization-operation-repository.js',
  './js/supabase/current-device-authorization-service.js?rev=account-scoped-device-identity-v1',
  './js/supabase/device-authorization-administration-service.js?rev=device-single-replacement-v1',
  './js/sync/current-device-authorization-ui.js?rev=account-scoped-device-identity-v1',
  ...
  './js/supabase/snapshot-sync.js?rev=account-scoped-device-identity-v1',
  ...
  './js/sync/sync-settings-ui.js?rev=account-scoped-device-identity-v1',
  './js/supabase/first-system-bootstrap-service.js?rev=first-owner-bootstrap-hardening-v1',
  './js/sync/startup-access-gate.js?rev=account-scoped-device-identity-v1',
  './js/sync/link-status-diagnostic-store.js',
  './js/sync/conference-link-store.js',
  './js/sync/conference-membership-attempt-store.js',
  './js/sync/conference-members-service.js?rev=account-scoped-device-identity-v1',
  ...
  './js/sync/user-management-ui.js?rev=account-scoped-device-identity-v1',
  './js/sync/conference-linking-attempt-store.js',
  './js/sync/conference-linking-service.js?rev=account-scoped-device-identity-v1',
  ...
  './version.js',
  './pwa.js?rev=account-scoped-device-identity-v1',
