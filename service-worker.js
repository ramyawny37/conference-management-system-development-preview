...
const CACHE_REVISION = IS_DEVELOPMENT
  ? 'development-3-4-0-platform-shell-phase1b-v1'
  : 'production-integrated-3-3-0-main-6d0c1e1-develop-80653ca-v1';
const CACHE_NAME = CACHE_PREFIX + 'v' + APP_VERSION + '-' + CACHE_REVISION;
const CORE_ASSETS = [
  './',
  './index.html',
  './shared-design-tokens.css?rev=platform-shell-phase1b-v1',
  './style.css?rev=platform-shell-phase1b-v1',
  ...
  './js/sync/startup-access-gate.js?rev=account-session-identity-v1',
  ...
  './script.js?rev=platform-shell-phase1b-v1',
  './version.js',
