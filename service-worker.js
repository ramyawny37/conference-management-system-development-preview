...
const CACHE_REVISION = 'conference-runtime-stability-v1';
...
const CORE_ASSETS = [
  ...
  './js/sync/discovered-conference-open-service.js?rev=conference-runtime-stability-v1',
  './js/sync/member-runtime-diagnostics.js?rev=conference-runtime-stability-v1',
  ...
  './cards.js',
  './script.js?rev=conference-runtime-stability-v1',
  './version.js',
  './pwa.js',
