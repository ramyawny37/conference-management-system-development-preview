...
const CORE_ASSETS = [
  ...
  './js/sync/current-device-authorization-ui.js?rev=device-reauthorization-flow-v1',
  './js/sync/device-reauthorization-flow.js?rev=device-reauthorization-flow-v1',
  './js/sync/device-authorization-administration-ui.js?rev=device-single-replacement-v1',
  ...
  './js/sync/discovered-conference-open-service.js?rev=canonical-conference-schema-v1',
  './js/sync/member-runtime-diagnostics.js?rev=canonical-conference-schema-v1',
