...
const CACHE_REVISION = 'mobile-person-picker-trigger-v3';
const CACHE_NAME = CACHE_PREFIX + 'v' + APP_VERSION + '-' + CACHE_REVISION;
const CORE_ASSETS = [
  './',
  './index.html',
  './style.css?rev=mobile-person-picker-trigger-v3',
  ...
  './js/sync/sync-settings-ui.js?rev=organization-membership-operation-key-v1',
  ...
  './script.js?rev=mobile-person-picker-trigger-v3',
  './version.js',
