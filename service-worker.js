...
const CACHE_REVISION = 'accommodation-reference-ui-v3';
const CACHE_NAME = CACHE_PREFIX + 'v' + APP_VERSION + '-' + CACHE_REVISION;
const CORE_ASSETS = [
  './',
  './index.html',
  './style.css?rev=accommodation-reference-ui-v3',
  ...
  './utils.js',
  './core.js?rev=accommodation-reference-ui-v3',
  ...
  './state.js?rev=accommodation-reference-ui-v3',
  './js/conference/accounts.js',
  './js/conference-template-houses-editor.js',
  './cards.js',
  './libs/xlsx.full.min.js',
  './script.js?rev=accommodation-reference-ui-v3',
  './version.js',
