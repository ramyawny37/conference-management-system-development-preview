...
const CACHE_REVISION = 'conflict-finalization-diagnostics-v1';
...
const CORE_ASSETS = [
  ...
  './js/sync/conference-realtime-manager.js?rev=realtime-already-subscribed-completion-v1',
  ...
  './js/sync/member-runtime-diagnostics.js?rev=conflict-finalization-diagnostics-v1',
