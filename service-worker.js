...
const CACHE_REVISION = 'launch-membership-integrity-v1';
...
const CORE_ASSETS = [
  ...
  './js/storage/conference-publishing-engine.js?rev=launch-membership-integrity-v1',
  './js/storage/conference-publish-recovery.js?rev=launch-membership-integrity-v1',
  ...
  './js/supabase/auth.js?rev=launch-membership-integrity-v1',
  ...
  './js/supabase/organization-administration-service.js?rev=launch-membership-integrity-v1',
  ...
  './js/sync/current-device-authorization-ui.js?rev=launch-membership-integrity-v1',
  ...
  './js/supabase/snapshot-sync.js?rev=launch-membership-integrity-v1',
  ...
  './js/sync/user-management-ui.js?rev=launch-membership-integrity-v1',
  './js/sync/conference-linking-attempt-store.js',
  './js/sync/conference-linking-service.js?rev=launch-membership-integrity-v1',
  ...
  './version.js',
  './pwa.js?rev=launch-membership-integrity-v1',
