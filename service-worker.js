...
const CACHE_REVISION = 'realtime-cloud-lifecycle-binding-v1';
...
const CORE_ASSETS = [
  ...
  './js/sync/realtime-locks-ui.js?rev=realtime-cloud-lifecycle-binding-v1',
  ...
  './js/sync/conference-realtime-manager.js?rev=realtime-cloud-lifecycle-binding-v1',
  ...
  './js/sync/member-runtime-diagnostics.js?rev=realtime-cloud-lifecycle-binding-v1',
  './js/sync/automatic-sync-orchestrator.js?rev=realtime-cloud-lifecycle-binding-v1',
