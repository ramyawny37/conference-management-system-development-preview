...
const CACHE_REVISION = 'realtime-runtime-listener-v1';
...
const CORE_ASSETS = [
  ...
  './js/sync/conference-realtime-manager.js?rev=realtime-runtime-listener-v1',
  ...
  './js/sync/discovered-conference-open-service.js?rev=realtime-runtime-listener-v1',
  './js/sync/member-runtime-diagnostics.js?rev=realtime-runtime-listener-v1',
