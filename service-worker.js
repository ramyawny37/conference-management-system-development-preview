...
const CACHE_REVISION = IS_DEVELOPMENT
  ? 'development-3-4-0-warehouse-remaining-operations-v1'
...
const CORE_ASSETS = [
  ...
  './js/warehouse/remaining-operations.js?rev=warehouse-remaining-operations-v1',
  './js/warehouse/workspace.js?rev=warehouse-remaining-operations-v1',
