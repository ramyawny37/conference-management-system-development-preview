...
const CACHE_REVISION = 'organization-membership-reconciliation-v1';
...
const CORE_ASSETS = [
  ...
  './js/supabase/organization-administration-service.js?rev=organization-membership-reconciliation-v1',
  './js/sync/organization-members-ui.js?rev=organization-membership-reconciliation-v1',
