...
const CACHE_REVISION = 'realtime-ui-manager-binding-v1';
...
const CORE_ASSETS = [
  ...
  './js/sync/realtime-locks-ui.js?rev=realtime-ui-manager-binding-v1',
  ...
  './js/sync/conference-realtime-manager.js?rev=realtime-ui-manager-binding-v1',
  ...
  './js/sync/member-runtime-diagnostics.js?rev=realtime-ui-manager-binding-v1',
