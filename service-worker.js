...
const CACHE_REVISION = 'accommodation-dashboard-v2';
const CACHE_NAME = CACHE_PREFIX + 'v' + APP_VERSION + '-' + CACHE_REVISION;
const CORE_ASSETS = [
  './',
  './index.html',
  './style.css?rev=accommodation-dashboard-v2',
  ...
  './utils.js',
  './core.js?rev=accommodation-dashboard-v2',
  ...
  './state.js?rev=accommodation-dashboard-v2',
  './js/conference/accounts.js',
  './js/conference-template-houses-editor.js',
  './cards.js',
  './libs/xlsx.full.min.js',
  './script.js?rev=accommodation-dashboard-v2',
  './version.js',
