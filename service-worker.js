...
const CORE_ASSETS = [
  ...
  './js/storage/indexeddb.js?rev=snapshot-payload-diagnostics-v1',
  './js/storage/storage-repository.js?rev=snapshot-payload-diagnostics-v1',
  ...
  './script.js?rev=post-restore-queue-review-v1',
  './version.js',
