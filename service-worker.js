...
const CORE_ASSETS = [
  ...
  './modules/reservations/reservations-module.css?rev=mountable-bundle-v5',
  ...
  './js/platform-integration.js?rev=reservations-module-integration-v1',
  './modules/reservations/reservations-module.js?rev=mountable-bundle-v5',
